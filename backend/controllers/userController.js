...
//         return res.status(200).json({
//             success: true,
//             msg: "mail verification link sent to your email. Plese verify"
//         })
...
//         if (userData) {
//             if (userData.is_verified == 1) {
//                 return res.render('mail-verification', { message: 'E-mail Already verified' })
//             }
...
//             });
//             return res.render('mail-verification', { message: 'E-Mail has been verified successfully' })
